...
Provides the steps to acquire the product software from Broadcom Support by downloading the z/OSMF portable software instance to the z/OSMF host. You must then register the portable software instance in z/OSMF.
